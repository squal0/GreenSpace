...
<html>
    <head>
        ...
        <title>Edit User - GreenSpace Environment</title>
    ...
    <body>
        ...
        <%  
            ...
            RegisterBean user=EditUserDao.getRecordString(id);  
        %> 
        ...
        <div class="container" id="register-form">
            ...
            <div class="errors" id="errors">
                ...
                <form method="post" action="update-user.jsp" name="register-form" onsubmit="return validate()">
                     
                <label><span>Name</span></label>
                <input type="text" class="form-control" placeholder="Enter Your Full Names" name="name" value="<%=user.getName() %>" required >
                
                <label><span>Username</span></label>
                <input type="text" class="form-control" placeholder="Enter Username" name="username" value="<%=user.getUsername()%>" required >
                
                <label><span>Roll No / Employee No</span></label>
                <input type="text" class="form-control" placeholder="Enter your Enrollment No or Employee No " name="rollno" value="<%=user.getRollno() %>" required >
                
                <label><span>Admission Date / Date of  Joining</span></label>
                <input type = "text" class="form-control" id = "datepicker-13" placeholder="Enter Admission Date or Date of Joining" name="date" value="<%=user.getDate() %>" required >
                
                <label><span>Class</span></label>
                <input type="text" class="form-control" placeholder="Enter Class" name="classSpec" value="<%=user.getClass_spec() %>" required >
                
                <label><span>Specification</span></label>
                <input type="text" class="form-control" placeholder="Enter Specification" name="specification" value="<%=user.getSpecification()%>" required >

                <label><span>Password</span></label>
                <input type="password" class="form-control" placeholder="Enter Password" name="password" value="<%=user.getPassword() %>" required >
                ...
                <button type="submit" class="btn btn-primary btn-lg btn-block">Edit Details</button>
