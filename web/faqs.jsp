...
<html>
    <head>
        ...
        <title>FAQs - GreenSpace Environment</title>
                    ...
                    <p>
                        <ul>
                            <li>
                                ...
                                <p> To participate in a survey the user should have registered for an account. Navigate to the<br/>
                            ...
                            <li>
                                ...
                                <p>Should a user encounter a technical problem when using the <strong>Enviromental Survey Portal</strong>,<br/>
